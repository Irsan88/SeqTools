...
#export SCRIPT_GATK=$DIR_SCRIPTS/GenomeAnalysisTK-2.4-7-g5e89f01/GenomeAnalysisTK.jar
#export SCRIPT_GATK=$DIR_SCRIPTS/GenomeAnalysisTK-2.4-9-g532efad/GenomeAnalysisTK.jar
export SCRIPT_GATK=$DIR_SCRIPTS/GenomeAnalysisTK-2.5-2-gf57256b/GenomeAnalysisTK.jar
#export SCRIPT_GATK=$DIR_SCRIPTS/GenomeAnalysisTK-2.6-4-g3e5ff60/GenomeAnalysisTK.jar
